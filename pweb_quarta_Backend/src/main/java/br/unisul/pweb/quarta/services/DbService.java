...
public class DbService {
	...
	public void inicializaBancoDeDados() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Laus Vandresen", "laus1205@hotmail.com", "07833167940", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("48954106431", "48999106431"));

		Endereco en1 = new Endereco(null, "Avenida Acácio Moreira ", "264", "Apto 304", "Tubarao"     , "88701010", cli1, c2);
